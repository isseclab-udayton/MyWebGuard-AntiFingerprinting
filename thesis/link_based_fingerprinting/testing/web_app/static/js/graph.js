...
function updateGraphs() {
    ...
    // Oregon State graph
    var oregonID = document.getElementById("OregonStateVal")
    ...
    // Penn State graph
    var pennStateID = document.getElementById("PennStateVal")
    Plotly.extendTraces('pennStateGraph', {
        y: [[pennStateID.value]]
    }, [0])

    // North Dakota graph
    var northDakotaID = document.getElementById("NorthDakotaVal")
